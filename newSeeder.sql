...
VALUES (1, "San Antonio", "07/14/2017 1100", "07/14/2017 1200", "Please come and join us at the local Petsmart. We will be there on Saturday", "" , "http://petsmart.com", "Texas", "111 Dezaval Rd", "", "Adoption Event", "78249" , NULL);
...
INSERT INTO pet_images (id, image_description, image_url, profile_pic)
...
INSERT INTO pets (id, age, arrival_date, breed, name, private_notes, ready_to_adopt, species, story, user_adopter_id, user_foster_id)
VALUES
/*So the data below isn't matching the table names above*/
  (50, 4, 'Henry', '', '', 'Donkey', 'Henry was found wandering through a subdivision like a donkey without an owner.',
       NULL, 1, '', '', '07/07/2017'),
  ...
  (71, 0, 'Hera', 'Now tests negative for infection', '', 'Cat',
       ...
       NULL, 2, 'Domestic Short Hair', '', '06/03/2017'), (72, 4, 'Jax', 'FIV+ positive', '', 'Cat',
                                                               'Jax is a male 4-year old grey & white shorthair. He is a curious guy and loves to explore. He isn\'t the most affectionate cat, but he would still love to relax with you and enjoy a snack. Jax LOVES snacks.  He is FIV+, so would do best as an only cat in the home. Any doggy friends would need to come by for a meet and greet to see how he does with them.',
                                                               NULL, 4, 'Domestic Short Hair', '', '06/15/2017');
...
INSERT INTO users (id, city, email, first_name, last_name, main_phone, password, state, street_add1, street_add2, username, zip)
...
VALUES (1, '', '', '5553332222', 'San Antonio', 'dave@mail.com', 'Bill', 'Smith', '2104947321',
  ...
  (2, '', '', '', 'San Antonio', 'tom@mail.com', 'Bob', 'Skylar', '2104437321',
   ...
   '47403'), (3, '', '', '', 'San Antonio', 'sarah@mail.com', 'Sarah', 'Heisenberg', '2106637321',
                 '$2a$10$yfNI.cGx.c5FF1b67bl.9u6b/6aoLneBtrfEPXIP3z47a4s/IQYRO', 'Texas', '132 Blue Way', '',
              'sarahisdabomb', '47405'),
  (4, '', '', '', 'San Antonio', 'melanie@mail.com', 'Melanie', 'Tucon', '2914947321',
   ...
   '47401'), (5, NULL, NULL, ' ', 'San Antonio', 'melody@gmail.com', 'Melody', 'Templeton', '210-413-8366',
                 '$2a$10$yfNI.cGx.c5FF1b67bl.9u6b/6aoLneBtrfEPXIP3z47a4s/IQYRO', 'TX', '3333 Pleasant Dr', '', 'melody',
              '78261'), (6, NULL, NULL, '', 'San Antonio', 'micah@mail.com', 'Micah', 'Disney', '210-555-3421',
                            '$2a$10$yfNI.cGx.c5FF1b67bl.9u6b/6aoLneBtrfEPXIP3z47a4s/IQYRO', 'TX', '1234 Bittersweet Dr',
                         '', 'micah', '78258'), (7, NULL, NULL, NULL, NULL, 'derek@mail.com', NULL, NULL, NULL,
                                                    '$2a$10$yfNI.cGx.c5FF1b67bl.9u6b/6aoLneBtrfEPXIP3z47a4s/IQYRO',
